...
Neste laboratório, pratiquei a segmentação lógica de redes usando VLANs e a comunicação entre diferentes VLANs por meio do método Router-on-a-Stick.

Os principais aprendizados foram:

- Criação e nomeação de VLANs
- Diferença entre portas access e trunk
- Associação de portas a VLANs específicas
- Isolamento entre VLANs
- Funcionamento do trunk 802.1Q
- Configuração de subinterfaces em roteador
- Uso de gateways por VLAN
- Roteamento entre VLANs
- Validação da rede com comandos `show`
- Troubleshooting de VLANs, trunks e subinterfaces
