...
Neste laboratório, pratiquei o funcionamento do STP em uma topologia com redundância de camada 2.

Os principais aprendizados foram:

- Como o STP evita loops em redes com links redundantes
- Como identificar a Root Bridge
- Como alterar a prioridade STP
- Diferença entre Root Port, Designated Port e Blocking Port
- Como testar failover em camada 2
- Quando aplicar PortFast
- Quando aplicar BPDU Guard
- Por que não aplicar PortFast/BPDU Guard em portas entre switches
- Como identificar e corrigir portas em `err-disabled`
- Diferença visual entre porta bloqueada pelo STP e porta com erro no Packet Tracer
